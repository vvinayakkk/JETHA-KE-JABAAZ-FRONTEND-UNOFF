        "use client"; 
        import { cn } from "./utils"; // Ensure the path is correct for your project structure
        ...
        return (
            ...
            <motion.span
                ...
                className={cn("block rounded-sm w-[4px] h-4 sm:h-6 xl:h-12 bg-purple-500", cursorClassName)}></motion.span>
            </div>
        );
        };
